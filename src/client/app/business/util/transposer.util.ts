...
export function tuneDown(tune: Tune) {
    ...
    for (var i = 0; i < Reihe.length; ++i) {
        ...
        if ((Aktuellereihe[0] === 'A' && Aktuellereihe[1] === ':') || (Aktuellereihe[0] === 'B' && Aktuellereihe[1] === ':')
            || (Aktuellereihe[0] === 'C' && Aktuellereihe[1] === ':') || (Aktuellereihe[0] === 'D' && Aktuellereihe[1] === ':')
            || (Aktuellereihe[0] === 'E' && Aktuellereihe[1] === ':') || (Aktuellereihe[0] === 'F' && Aktuellereihe[1] === ':')
            || (Aktuellereihe[0] === 'G' && Aktuellereihe[1] === ':') || (Aktuellereihe[0] === 'H' && Aktuellereihe[1] === ':')
            || (Aktuellereihe[0] === 'I' && Aktuellereihe[1] === ':') || (Aktuellereihe[0] === 'J' && Aktuellereihe[1] === ':')
            || (Aktuellereihe[0] === 'L' && Aktuellereihe[1] === ':') || (Aktuellereihe[0] === 'M' && Aktuellereihe[1] === ':')
            || (Aktuellereihe[0] === 'N' && Aktuellereihe[1] === ':') || (Aktuellereihe[0] === 'O' && Aktuellereihe[1] === ':')
            || (Aktuellereihe[0] === 'P' && Aktuellereihe[1] === ':') || (Aktuellereihe[0] === 'Q' && Aktuellereihe[1] === ':')
            || (Aktuellereihe[0] === 'R' && Aktuellereihe[1] === ':') || (Aktuellereihe[0] === 'S' && Aktuellereihe[1] === ':')
            || (Aktuellereihe[0] === 'T' && Aktuellereihe[1] === ':') || (Aktuellereihe[0] === 'U' && Aktuellereihe[1] === ':')
            || (Aktuellereihe[0] === 'V' && Aktuellereihe[1] === ':') || (Aktuellereihe[0] === 'W' && Aktuellereihe[1] === ':')
            || (Aktuellereihe[0] === 'X' && Aktuellereihe[1] === ':') || (Aktuellereihe[0] === 'Y' && Aktuellereihe[1] === ':')
            || (Aktuellereihe[0] === 'Z' && Aktuellereihe[1] === ':')) {
