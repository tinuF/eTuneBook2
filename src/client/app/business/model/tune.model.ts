...
import { Color, Video, Website, PlayDate } from '../model/index';
import { getAbcValueOfTuneLine, getAbcValue, getSubDirective, calculateFrequencyPlayed } from '../util/index';
...
export class Tune {
    ...
    importVideo(videoDirective: string) {
        return new Video(this.importVideoSource(videoDirective),
            this.importVideoCode(videoDirective), this.importVideoDescription(videoDirective));
    }
