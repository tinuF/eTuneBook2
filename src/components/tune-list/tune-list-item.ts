...
import {TunePlayedUI} from '../../components/common/tune/tune-played';

@Component({
    selector: 'etb-tune-list-item',
    templateUrl: './components/tune-list/tune-list-item.html',
    directives: [ROUTER_DIRECTIVES, SampleDotsUI, TunePlayedUI],
    styleUrls: ['./components/tune-list/tune-list-item.css'],
