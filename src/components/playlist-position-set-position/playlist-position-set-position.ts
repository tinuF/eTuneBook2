...
@Component({
    ...
    templateUrl: './components/playlist-position-set-position/playlist-position-set-position.html',
    ...
    styleUrls: ['./components/playlist-position-set-position/playlist-position-set-position.css'],
