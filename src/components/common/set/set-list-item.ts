...
import {SetPositionUI} from '../../../components/common/set/set-position';
import {SetPlaylistListUI} from '../../../components/common/set/set-playlist-list';
import {FilterSettings} from '../../../common/settings/filter-settings';


@Component({
    selector: 'etb-set-list-item',
    templateUrl: './components/common/set/set-list-item.html',
    directives: [ROUTER_DIRECTIVES, SampleDotsUI, SetPositionUI, SetPlaylistListUI],
    styleUrls: ['./components/common/set/set-list-item.css'],
