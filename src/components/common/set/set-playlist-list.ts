...
import {SetPlaylistListItemUI} from '../../../components/common/set/set-playlist-list-item';


@Component({
    selector: 'etb-set-playlist-list',
    templateUrl: './components/common/set/set-playlist-list.html',
    directives: [ROUTER_DIRECTIVES, SetPlaylistListItemUI],
    styleUrls: ['./components/common/set/set-playlist-list.css']
})
