...
@Component({
    ...
    templateUrl: './components/tune/tune-video-list-item.html',
    styleUrls: ['./components/tune/tune-video-list-item.css']
})
export class TuneVideoListItemUI implements OnInit, OnDestroy {
    @Input() video: Video;
    @Input() tune: Tune;
