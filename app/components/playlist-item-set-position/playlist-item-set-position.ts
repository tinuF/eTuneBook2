...
@Component({
    ...
    templateUrl: './components/playlist-item-set-position/playlist-item-set-position.html',
    directives: [ROUTER_DIRECTIVES, TunePlayedUI],
    styleUrls: ['./components/playlist-item-set-position/playlist-item-set-position.css'],
