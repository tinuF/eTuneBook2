...
@Component({
    ...
    templateUrl: './components/playlist-position-set-position-play-info/playlist-position-set-position-play-info.html',
    directives: [ROUTER_DIRECTIVES, TuneDotsUI, SampleDotsUI, TunePlayedUI, PlaylistTuneUI, SetListItemUI, PartPlayInfoListUI],
    styleUrls: ['./components/playlist-position-set-position-play-info/playlist-position-set-position-play-info.css'],
